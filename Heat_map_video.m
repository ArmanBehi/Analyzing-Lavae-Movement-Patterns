function [] = Heat_map_video(data_table,name_of_the_video,nbins,periods)
%This code generates a video of the heat map depicting the moving average bin. 
% The first input is the data_table that could be achived by shiny, 
% and the second input is the name that depicts in the top of video and also the name that you want to save the video with. 
% Third input is the number of bins, it divides the plate into that number of bins and calculate distribution of presence in each bin.I used 75, but you can increase it by incrementing your sample size. 
% The last input is show how much wide you want your averaging bin to be (it is on second scale)
